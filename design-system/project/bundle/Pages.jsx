    ...
    <div id="content">
      ...
      <p>
        ...
        <span className="lpu-inline-badge">
          <img src={window.__resources.lpuLogo} alt="" className="lpu-inline-logo" />
      ...
      <p><img src={window.__resources.mainPortrait} title="image credit: meret vollenweider and sam nguyen, 201510" alt="Dharun Ashokkumar" /></p>
      ...
      <div className="about-wrapper">
        ...
        <aside className="wiki-infobox">
          <div className="infobox-image">
            <img src={window.__resources.mainPortrait} alt="Dharun" />
...
function ProjectDetailPage({ id, go }) {
  ...
  return (
    <div id="content">
      ...
      <p><img src={window.__resources.linecube} alt="" /></p>
      <h3>what it is</h3>
